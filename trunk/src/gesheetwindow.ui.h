...
void GESheetWindow::pushSmallCommand ( QUndoCommand* cmd )
{
...
void GESheetWindow::registerNewSmall ( GEVSmall* smallv )
{
    ...
    connect( smallv, SIGNAL(pushThisCommand(QUndoCommand*)),
             this, SLOT(pushSmallCommand(QUndoCommand*)) );
}
