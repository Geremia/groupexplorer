...
class GTCmdEditCell : public QUndoCommand
{
public:
...
class GTCmdSortColumn : public QUndoCommand
{
public:
...
class GTCmdReorderRows : public QUndoCommand
{
public:
...
class GTCmdReorderColumns : public QUndoCommand
{
public:
...
class GTCmdHideShowColumn : public QUndoCommand
{
public:
...
class GTCmdDeleteColumn : public QUndoCommand
{
public:
...
class GTCmdRenameColumn : public QUndoCommand
{
public:
...
class GTCmdCreateColumn : public QUndoCommand
{
public:
...
class GTCmdApplyPreferences : public QUndoCommand
{
public:
...
class GTCmdResizeColumn : public QUndoCommand
{
public:
...
protected:
    virtual bool mergeMeWith ( QUndoCommand* c );
