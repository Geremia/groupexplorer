...
class GEShCmdInsertText : public QUndoCommand
{
public:
...
class GEShCmdInsertRect : public QUndoCommand
{
public:
...
class GEShCmdInsertVisualizer : public QUndoCommand
{
public:
...
class GEShCmdZoomIn : public QUndoCommand
{
public:
...
class GEShCmdZoomOut : public QUndoCommand
{
public:
...
class GEShCmdMovedSelection : public QUndoCommand
{
public:
...
class GEShCmdSelectItems : public QUndoCommand
{
public:
...
class GEShCmdChangeText : public QUndoCommand
{
public:
...
class GEShCmdResizeText : public QUndoCommand
{
public:
...
class GEShCmdCutItems : public QUndoCommand
{
public:
...
class GEShCmdPasteItems : public QUndoCommand
{
public:
...
class GEShCmdResizedItem : public QUndoCommand
{
public:
...
class GEShCmdPushSelectionZ : public QUndoCommand
{
public:
...
{
public:
    GEShCmdConnectWithLine ( QUndoStack* undoStack );
    virtual bool setup ();
    virtual void redo ();
    virtual void undo ();
...
{
public:
    GEShCmdConnectWithMorphism ( QUndoStack* undoStack, QString morphName );
    virtual bool setup ();
    virtual void redo ();
    virtual void undo ();
...
class GEShCmdChangeMorphism : public QUndoCommand
{
public:
