...
CONFIG	+= qt warn_on release opengl uic3
...
#  CONFIG -= warn_off
#  CONFIG -= warn_on
#  QMAKE_CFLAGS += -fmessage-length=200 -Wall -W -Wextra -Wno-non-virtual-dtor
#  QMAKE_CXXFLAGS += -fmessage-length=200 -Wall -W -Wextra -Wno-non-virtual-dtor
#  # this makes this a static build:
#  QMAKE_LIBS_QT =
